...
int main(void){
	...
	if(display_header==TRUE){
		...
		if(display_type==DISPLAY_HOSTS)
			printf("%s host",(show_all_hosts==TRUE)?"所有":"该");
		else
			printf("服务");
		printf("XXXXXXXXX");
		printf(":</td>\n");
