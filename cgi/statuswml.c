 ...
 * 
 * !ATTENTION! this file char code is UTF-8   FZSongti
...
void display_index(void){
	...
	printf("<card id='card1' title='WAP接口'>\n");
	printf("<p align='center' mode='nowrap'>\n");

	printf("<b>Nagios</b><br/><b>WAP接口</b><br/>\n");

	printf("<b><anchor title='Quick Stats'>快速查看状态<go href='%s'><postfield name='style' value='quickstats'/></go></anchor></b><br/>\n",STATUSWML_CGI);

	printf("<b><anchor title='Status Summary'>状态汇总<go href='%s'><postfield name='hostgroup' value='all'/><postfield name='style' value='summary'/></go></anchor></b><br/>\n",STATUSWML_CGI);

	printf("<b><anchor title='Status Overview'>状态概要<go href='%s'><postfield name='hostgroup' value='all'/><postfield name='style' value='overview'/></go></anchor></b><br/>\n",STATUSWML_CGI);

	printf("<b><anchor title='All Problems'>所有的故障<go href='%s'><postfield name='style' value='aprobs'/></go></anchor></b><br/>\n",STATUSWML_CGI);

	printf("<b><anchor title='Unhandled Problems'>未处理的故障<go href='%s'><postfield name='style' value='uprobs'/></go></anchor></b><br/>\n",STATUSWML_CGI);

	printf("<b><anchor title='Process Info'>进程信息<go href='%s'><postfield name='style' value='processinfo'/></go></anchor></b><br/>\n",STATUSWML_CGI);

	printf("<b><anchor title='Network Tools'>工具<go href='#card2'/></anchor></b><br/>\n");

	printf("<b><anchor title='About'>关于该软件<go href='#card3'/></anchor></b><br/>\n");
	...
	printf("<b><anchor title='View Host'>主机<go href='#card4'/></anchor></b><br/>\n");
	printf("<b><anchor title='View Hostgroup'>主机组<go href='#card5'/></anchor></b><br/>\n");
...
void display_process(void){
	...
	if(nagios_process_state==STATE_OK)
		printf("Nagios进程正常运行。<br/>\n");
	else
		printf("<b>Nagios进程未运行。</b><br/>\n");
	...
	printf("<br/>\n");
	printf("<b><anchor title='Process Commands'>进程命令<go href='#card2'/></anchor></b>\n");
	printf("</p>\n");
	...
	if(enable_notifications==FALSE)
		printf("<b><anchor title='Enable Notifications'>通知启用<go href='%s' method='post'><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,CMD_ENABLE_NOTIFICATIONS,CMDMODE_COMMIT);
	else
		printf("<b><anchor title='Disable Notifications'>通知禁用<go href='%s' method='post'><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,CMD_DISABLE_NOTIFICATIONS,CMDMODE_COMMIT);

	if(execute_service_checks==FALSE)
		printf("<b><anchor title='Enable Check Execution'>检查启用<go href='%s' method='post'><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,CMD_START_EXECUTING_SVC_CHECKS,CMDMODE_COMMIT);
	else
		printf("<b><anchor title='Disable Check Execution'>检查禁用<go href='%s' method='post'><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,CMD_STOP_EXECUTING_SVC_CHECKS,CMDMODE_COMMIT);
...
void display_quick_stats(void){
	...
	printf("<b>主机的汇总</b>:<br/>\n");
	printf("运行状态<br>(UP)<br>[ %d  ]<br/><br/>\n",hosts_up);
	printf("宕机状态<br>(DOWN)<br>[ %d  ]<br/><br/>\n",hosts_down);
	printf("不可达状态<br>(UNREACHABLE)<br>[ %d  ]<br/><br/>\n",hosts_unreachable);
	printf("未决状态<br>(PENDING)<br>[ %d  ]<br/><br/>\n",hosts_pending);

	printf("<br/>\n");
	
	printf("<b>服务的汇总</b>:<br/>\n");
	printf("正常状态<br>(OK)<br>[ %d  ]<br/><br/>\n",services_ok);
	printf("告警状态<br>(WARNING)<br>[ %d  ]<br/><br/>\n",services_warning);
	printf("未知状态<br>(UNKNOWN)<br>[ %d  ]<br/><br/>\n",services_unknown);
	printf("紧急状态<br>(CRITICAL)<br>[ %d  ]<br/><br/>\n",services_critical);
	printf("未决状态<br>(PENDING)<br>[ %d  ]<br/><br/>\n",services_pending);
...
void display_hostgroup_overview(void){
	...
	printf("<b><anchor title='Status Overview'>状态概要<go href='%s' method='post'><postfield name='hostgroup' value='%s'/><postfield name='style' value='summary'/></go></anchor></b><br/><br/>\n",STATUSWML_CGI,hostgroup_name);
	...
	if(show_all_hostgroups==FALSE)
		printf("<b><anchor title='View All Hostgroups'>所有的主机组<go href='%s' method='post'><postfield name='hostgroup' value='all'/><postfield name='style' value='overview'/></go></anchor></b>\n",STATUSWML_CGI);
...
void display_hostgroup_summary(void){
	...
	printf("<b><anchor title='Status Summary'>状态汇总<go href='%s' method='post'><postfield name='hostgroup' value='%s'/><postfield name='style' value='overview'/></go></anchor></b><br/><br/>\n",STATUSWML_CGI,hostgroup_name);
	...
	for(temp_hostgroup=hostgroup_list;temp_hostgroup!=NULL;temp_hostgroup=temp_hostgroup->next){
		...
		if(hosts_unreachable>0){
			printf("不可达: %d",hosts_unreachable);
			found=1;
		        }
		if(hosts_down>0){
			printf("%s 宕机: %d",(found==1)?", ":"",hosts_down);
			found=1;
		        }
		if(hosts_pending>0){
			printf("%s 未决: %d",(found==1)?", ":"",hosts_pending);
			found=1;
		        }
		printf("%s 运行: %d",(found==1)?", ":"",hosts_up);
		printf("</td></tr>\n");
		printf("<tr><td> </td><td> </td></tr>");
		printf("<tr><td>服务:</td><td>");
		found=0;
		if(services_critical>0){
			printf("紧急(CRI): %d",services_critical);
			found=1;
		        }
		if(services_warning>0){
			printf("%s 告警(WRN): %d",(found==1)?", ":"",services_warning);
			found=1;
		        }
		if(services_unknown>0){
			printf("%s 未知(UNK): %d",(found==1)?", ":"",services_unknown);
			found=1;
		        }
		if(services_pending>0){
			printf("%s 未决(PND): %d",(found==1)?", ":"",services_pending);
			found=1;
		        }
		printf("%s 正常(OK): %d",(found==1)?", ":"",services_ok);
		printf("</td></tr>\n");
	...
	if(show_all_hostgroups==FALSE)
		printf("<b><anchor title='View All Hostgroups'>所有的主机组<go href='%s' method='post'><postfield name='hostgroup' value='all'/><postfield name='style' value='summary'/></go></anchor></b>\n",STATUSWML_CGI);
...
void display_host(void){
	...
	printf("</table>\n");
	printf("<br/>\n");
	printf("<b><anchor title='View Services'>服务<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='style' value='servicedetail'/></go></anchor></b>\n",STATUSWML_CGI,host_name);
	printf("<b><anchor title='Host Commands'>主机命令<go href='#card2'/></anchor></b>\n");
	printf("</p>\n");
	...
	if(temp_hoststatus->status!=HOST_UP && temp_hoststatus->status!=HOST_PENDING)
		printf("<b><anchor title='Acknowledge Problem'>问题确认<go href='#card3'/></anchor></b>\n");

	if(temp_hoststatus->checks_enabled==FALSE)
		printf("<b><anchor title='Enable Host Checks'>启用主机检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,CMD_ENABLE_HOST_CHECK,CMDMODE_COMMIT);
	else
		printf("<b><anchor title='Disable Host Checks'>禁用主机检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,CMD_DISABLE_HOST_CHECK,CMDMODE_COMMIT);

	if(temp_hoststatus->notifications_enabled==FALSE)
		printf("<b><anchor title='Enable Host Notifications'>启用主机通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,CMD_ENABLE_HOST_NOTIFICATIONS,CMDMODE_COMMIT);
	else
		printf("<b><anchor title='Disable Host Notifications'>禁用主机通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,CMD_DISABLE_HOST_NOTIFICATIONS,CMDMODE_COMMIT);


	printf("<b><anchor title='Enable All Service Checks'>启用所有服务检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,CMD_ENABLE_HOST_SVC_CHECKS,CMDMODE_COMMIT);

	printf("<b><anchor title='Disable All Service Checks'>禁用所有服务检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,CMD_DISABLE_HOST_SVC_CHECKS,CMDMODE_COMMIT);

	printf("<b><anchor title='Enable All Service Notifications'>启用所有服务通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,CMD_ENABLE_HOST_SVC_NOTIFICATIONS,CMDMODE_COMMIT);

	printf("<b><anchor title='Disable All Service Notifications'>禁用所有服务通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,CMD_DISABLE_HOST_SVC_NOTIFICATIONS,CMDMODE_COMMIT);
...
void display_host_services(void){
	...
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>主机名 <anchor title='%s'>'%s'<go href='%s' method='post'><postfield name='host' value='%s'/></go></anchor> 服务</b><br/>\n",host_name,host_name,STATUSWML_CGI,host_name);
...
void display_service(void){
	...
	printf("</table>\n");
	printf("<br/>\n");
	printf("<b><anchor title='View Host'>主机<go href='%s' method='post'><postfield name='host' value='%s'/></go></anchor></b>\n",STATUSWML_CGI,host_name);
	printf("<b><anchor title='Service Commands'>服务命令<go href='#card2'/></anchor></b>\n");
	printf("</p>\n");
	...
	if(temp_servicestatus->checks_enabled==FALSE)
		printf("<b><anchor title='Enable Checks'>启用检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='service' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,service_desc,CMD_ENABLE_SVC_CHECK,CMDMODE_COMMIT);
	else{
		printf("<b><anchor title='Disable Checks'>禁用检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='service' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,service_desc,CMD_DISABLE_SVC_CHECK,CMDMODE_COMMIT);
		printf("<b><anchor title='Schedule Immediate Check'>安排检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='service' value='%s'/><postfield name='start_time' value='%lu'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,service_desc,(unsigned long)current_time,CMD_SCHEDULE_SVC_CHECK,CMDMODE_COMMIT);
	        }

	if(temp_servicestatus->notifications_enabled==FALSE)
		printf("<b><anchor title='Enable Notifications'>启用通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='service' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,service_desc,CMD_ENABLE_SVC_NOTIFICATIONS,CMDMODE_COMMIT);
	else
		printf("<b><anchor title='Disable Notifications'>禁用通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='service' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n",COMMAND_CGI,host_name,service_desc,CMD_DISABLE_SVC_NOTIFICATIONS,CMDMODE_COMMIT);
	...
	printf("<input name='name' value='%s' /><br/>\n",((use_ssl_authentication)?(getenv("SSL_CLIENT_S_DN_CN")):(getenv("REMOTE_USER"))));
	printf("<b>注释:</b><br/>\n");
	printf("<input name='comment' value='WAP相关的背景知识'/>\n");
...
void display_ping(void){
	...
	if(!strcmp(ping_address,"")){
		...
		printf("<p align='center' mode='nowrap'>\n");
		printf("<b>主机Ping检查</b><br/>\n");
		printf("</p>\n");

		printf("<p align='center' mode='wrap'>\n");
		printf("<b>主机名/地址:</b><br/>\n");
		...
		printf("<p align='center' mode='nowrap'>\n");
		printf("<b>%s Ping的结果:</b><br/>\n",ping_address);
		printf("</p>\n");

		printf("<p mode='nowrap'>\n");

		if(ping_syntax==NULL)
			printf("CGI配置的ping_syntax为空。\n");
...
void display_traceroute(void){
	...
	if(!strcmp(traceroute_address,"")){
		...
		printf("<p align='center' mode='nowrap'>\n");
		printf("<b>%s路由跟踪(Traceroute)的结果:</b><br/>\n",traceroute_address);
		printf("</p>\n");
...
void display_problems(void){
	...
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>%s故障</b><br/><br/>\n",(display_type==DISPLAY_ALL_PROBLEMS)?"所有的":"未处理的");
